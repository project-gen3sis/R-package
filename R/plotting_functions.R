...
#' @param n corresponds to the \link[grDevices]{colorRampPalette} parameter 
#' @return returns a \link[grDevices]{colorRampPalette} function with the gen3sis richness colours
#' @export
