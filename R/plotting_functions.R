...
#' @param col corresponds to the \link[raster]{plot} col plot parameter. This can be omitted and colors are handled by raster::plot  
#' @param legend corresponds to the \link[raster]{plot} legend plot parameter. This can be omitted and legend is handled by raster::plot
