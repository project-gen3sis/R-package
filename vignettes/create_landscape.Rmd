...
The next step will be to create two arrays, one for each environmental variable. These two initially  empty arrays are 3 dimensional (2 spatial and 1 temporal dimension). Later we will save the environmental variable values for the landscape file.
...
For both temperature and precipitation uniform distribution of values over space is created. We then add environmental white noise to introduce spatial and temporal heterogenity. For the temperature layer this will be an average of 20°C with a standard deviation of 0.5°C, where as for precipitation we settle for an average value of 500 mm/year with a standard deviation of 50 mm/year.
