...
##This study case follow the General Dynamic Model of Island Biogeography (Whittaker et al. 2008 Journal of Biogeography), but the island dynamics entails only area dynamics
##Below, we create the landscape files for the experiment:
