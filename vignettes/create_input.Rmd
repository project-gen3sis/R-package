...
temp <-lapply(seq(dim(Dynamic_Landscape_Temperature)[3]), function(x){raster(Dynamic_Landscape_Temperature[ , , x], xmn = 0., xmx = 31., ymn = 0., ymx = 31.)})
#Transforming the precipitation array into a list of rasters
prec <-lapply(seq(dim(Dynamic_Landscape_Precipitation)[3]),function(x){raster(Dynamic_Landscape_Precipitation[ , , x], xmn = 0., xmx = 31., ymn = 0., ymx = 31.)})
```
