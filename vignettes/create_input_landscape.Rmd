...
Finally, don't forget to specify the important metadata for the landscape you just created. We recommend storing it in form of a metadata.txt file within the landscape folder.
