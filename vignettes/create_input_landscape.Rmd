...
Besides the (i) landscape list, (ii) cost function and (iii) experiment folder, we can define further arguments such as: directions, timesteps and calculate_full_distance_matrices. 
