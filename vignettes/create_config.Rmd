...
Note that the main core functions have a stop warning by default, so this configuration is empty and needs to be edited according to the model that
is to be implemented. You can do this from scratch or by modifiying an existing config.
