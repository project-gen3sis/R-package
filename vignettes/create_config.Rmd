...
>```{r eval=FALSE, fig.width=6, fig.height=3.2}
n <- 100
...
A configuration object can be modified by editing a file or the config object in R. Here we will load the *config_southamerica.R* as an R object and modify it's random seed.
