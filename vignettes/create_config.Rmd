...
c_sa <- create_input_config(file.path(datapath, "config/config_southamerica.R"))
c_sa$gen3sis$general$end_of_timestep_observer <- function(data, vars, config){
  save_species()
...
run_simulation(c_sa, landscape = file.path(datapath, "landscape"), output_directory=tempdir())
