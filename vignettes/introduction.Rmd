...
This is how the landscape we will use looks like at 65, 30 and 0Ma, below are the plots of temperature and aridity.
...
# ARIDITY
arid_300 <- rasterFromXYZ(landscapes$prec[, c(1,2,68)])
arid_65 <- rasterFromXYZ(landscapes$prec[, c(1,2,33)])
...
After having run the simulation, we can load and plot the species richness at different time-steps. Here, we will load them at the time-steps 40, 20 and 0. Since we have six time-steps within this time frame, this corresponds to 40, 20 and 0 Ma, respectively.
