...
Download the [landscape](https://github.com/project-Gen3sis) and the [configuration](https://github.com/project-Gen3sis) and store these in a new folder wherever you would like to run the experiment. Like this:
