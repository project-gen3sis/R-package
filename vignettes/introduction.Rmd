...
legend(15,17, legend=paste('n =', length(landscape_t0$rich)), bty='n')
```
...
legend(0.3,20, legend=paste('n =', length(landscape_t0$rich)), bty='n')
```
...
legend(150000, 22, col=c(rgb(0.5,0.5,0.5,0.4), 'black'), legend=c('observations', 'model fit'), pch=c(16, NA), lty=c(NA, 1), lwd=c(NA, 2))
legend(170000, 20, legend=paste('n =', length(landscape_t0$rich)), bty='n')
```
