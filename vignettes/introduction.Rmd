...
legend(5,20, col=c(rgb(0.5,0.5,0.5,0.4), 'red'), legend=c('observations', 'model fit'), pch=c(16, NA), lty=c(NA, 1), lwd=c(NA, 2))
require('ecospat')
legend(15,17, legend=paste('D^2 =', round(ecospat.adj.D2.glm(glm.uni),2)), bty='n')
```
...
legend(0,10, col=c(rgb(0.5,0.5,0.5,0.4), 'blue'), legend=c('observations', 'model fit'), pch=c(16, NA), lty=c(NA, 1), lwd=c(NA, 2))
legend(0.3,20, legend=paste('D^2 =', round(ecospat.adj.D2.glm(glm.uni),2)), bty='n')
```
...
legend(150000, 22, col=c(rgb(0.5,0.5,0.5,0.4), 'brown'), legend=c('observations', 'model fit'), pch=c(16, NA), lty=c(NA, 1), lwd=c(NA, 2))
legend(170000, 20, legend=paste('D^2 =', round(ecospat.adj.D2.glm(glm.uni),2)), bty='n')
```
