...
For more details on how to create a landscape and prepare it to use in *gen3sis* see [this vignette](design_landscape.html) and [this vignette](create_input_landscape.html). For more details on how to create or modify a configuration object see [this vignette](create_config.html)
