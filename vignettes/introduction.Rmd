...
After the simulation is finished, a plot is created at the CaseStudy1 folder to show the state of the initial world. We see, 1 species per cell in the 4 cell small island.

Excellent. Our virtual species are waiting for us. They are automatically stored in a subfolder called output inside our CaseStudy1 folder named after our configuration file (i.e. config). Like this:
