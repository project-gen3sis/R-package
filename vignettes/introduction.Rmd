...
The first step for running a  simulation consists of setting up the folder structure with the required input data.

from which the landscape object and the distance matrices are calculated. 
The second is 



The funciton run_simulation, our main function, will:
...
run_simulation(config_file = file.path(datapath,"config/config.R"), input_directory = file.path(datapath,"landscape"), verbose=1)
...
load(file.path(datapath"./EXPERIMENT_X/output/config/sgen3sis.RData"))
