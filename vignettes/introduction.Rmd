...
After having run the simulation we can load and plot the species richness at different time steps. Here, we will load them at the timesteps 300, 150 and 0. Since we have six time steps within this time frame, this corresponds to which correspond to 150, 125 and 100 Ma, respectively.
