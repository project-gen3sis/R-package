...
legend("topleft", col=c(rgb(0.5,0.5,0.5,0.4), 'black'), legend=c(n, 'model fit'), pch=c(16, NA), lty=c(NA, 1), lwd=c(NA, 2), bty='n')
```

Indeed aridity is correlated with temperature. Thus let's investigate the association of aridity and species richness by fitting a generalized linear model between richness and aridity
